...
describe("Vector test: ", function () {
    ...
    describe("Interpolate", function () {
        ...
        it("X Set 0.5", function () {
            expect(interpolatedVector.getX()).toEqual(45);
        });
        it("Y Set 0.5", function () {
            expect(interpolatedVector.getY()).toEqual(60);
        });
        interpolation = 0.25;
        var interpolatedVector2 = vector.interpolate(secondVector, interpolation);
        it("X Set 0.25", function () {
            expect(interpolatedVector2.getX()).toEqual(37.5);
        });
        it("Y Set 0.25", function () {
            expect(interpolatedVector2.getY()).toEqual(50);
        });
    });
